/*! For license information please see data-display-Avatar-Avatar-stories.09f2cb4b.iframe.bundle.js.LICENSE.txt */
(self.webpackChunknerdux_ui_system =
  ...
  [177],
  {
    "./src/data-display/Avatar/Avatar.stories.tsx": (
      ...
      var cx = bind_default().bind(Avatar_Avatar_module),
        Avatar = function Avatar(_ref) {
          var _ref$size = _ref.size,
            ...
            avatarClassName = cx(
              _defineProperty({ templateAvatar: !0 }, size, !0)
            ),
            defaultAvatarClassName = cx(
              _defineProperty({ templateDefault: !0 }, size, !0)
            );
          return (0, jsx_runtime.jsx)("div", {
            className: Avatar_Avatar_module.avatarWrapper,
            children: props.src
              ...
              : (0, jsx_runtime.jsx)("div", {
                  ...
                  children: (0, jsx_runtime.jsx)("p", { children: "A" }),
                }),
          });
        };
      ...
      const _1_namespaceObject =
        __webpack_require__.p + "static/media/1.89f32f9b.jpg";
      var _MultiAvatar$paramete, _MultiAvatar$paramete2, _MultiAvatar$paramete3;
      ...
      var MultiAvatar = function MultiAvatar(args) {
        return (0, jsx_runtime.jsx)(
          Avatar,
          _objectSpread({ alt: "", src: "" }, args)
        );
      };
      (MultiAvatar.displayName = "MultiAvatar"),
        ...
        (MultiAvatar.parameters = _objectSpread(
          _objectSpread({}, MultiAvatar.parameters),
          {},
          {
            docs: _objectSpread(
              _objectSpread(
                {},
                null === (_MultiAvatar$paramete = MultiAvatar.parameters) ||
                  void 0 === _MultiAvatar$paramete
                  ? void 0
                  : _MultiAvatar$paramete.docs
              ),
              {},
              {
                source: _objectSpread(
                  {
                    originalSource:
                      'args => <Avatar alt={""} src={""} {...args} />',
                  },
                  null === (_MultiAvatar$paramete2 = MultiAvatar.parameters) ||
                    void 0 === _MultiAvatar$paramete2 ||
                    null ===
                      (_MultiAvatar$paramete3 = _MultiAvatar$paramete2.docs) ||
                    void 0 === _MultiAvatar$paramete3
                    ? void 0
                    : _MultiAvatar$paramete3.source
                ),
              }
            ),
          }
        ));
      var __namedExportsOrder = ["MultiAvatar"];
    },
    "./node_modules/@storybook/builder-webpack5/node_modules/css-loader/dist/cjs.js??ruleSet[1].rules[13].use[1]!./src/data-display/Avatar/Avatar.module.css":
      (module, __webpack_exports__, __webpack_require__) => {
        ...
        ___CSS_LOADER_EXPORT___.push([
          ...
          ___CSS_LOADER_EXPORT___.push([
            module.id,
            '.src-data-display-Avatar-Avatar-module__avatarWrapper--TuSDi {\n  display: flex;\n  justify-content: center;\n  align-items: center;\n  font-family: "Inter", sans-serif;\n  height: 40px;\n  width: 40px;\n}\n\n.src-data-display-Avatar-Avatar-module__templateAvatar--Q9SaO {\n  border-radius: 50%;\n}\n\n.src-data-display-Avatar-Avatar-module__templateDefault--Pr0vt {\n  position: relative;\n  border-radius: 50%;\n  background-color: #23a094;\n}\n\n.src-data-display-Avatar-Avatar-module__templateDefault--Pr0vt p {\n  position: absolute;\n  top: 50%;\n  left: 50%;\n  transform: translate(-50%, -50%);\n  color: #ffffff;\n  margin: 0;\n}\n\n.src-data-display-Avatar-Avatar-module__big--ee2VB {\n  width: 40px;\n  height: 40px;\n}\n\n.src-data-display-Avatar-Avatar-module__medium--DXWgD {\n  width: 30px;\n  height: 32px;\n}\n\n.src-data-display-Avatar-Avatar-module__small--mgjwo {\n  width: 24px;\n  height: 24px;\n}\n',
            "",
            {
              version: 3,
              sources: [
              ...
              names: [],
              mappings:
                "AAEA;EACE,aAAa;EACb,uBAAuB;EACvB,mBAAmB;EACnB,gCAAgC;EAChC,YAAY;EACZ,WAAW;AACb;;AAEA;EACE,kBAAkB;AACpB;;AAEA;EACE,kBAAkB;EAClB,kBAAkB;EAClB,yBAAyB;AAC3B;;AAEA;EACE,kBAAkB;EAClB,QAAQ;EACR,SAAS;EACT,gCAAgC;EAChC,cAAc;EACd,SAAS;AACX;;AAEA;EACE,WAAW;EACX,YAAY;AACd;;AAEA;EACE,WAAW;EACX,YAAY;AACd;;AAEA;EACE,WAAW;EACX,YAAY;AACd",
              sourcesContent: [
                '@import url("https://fonts.googleapis.com/css2?family=Inter:wght@500&display=swap");\n\n.avatarWrapper {\n  display: flex;\n  justify-content: center;\n  align-items: center;\n  font-family: "Inter", sans-serif;\n  height: 40px;\n  width: 40px;\n}\n\n.templateAvatar {\n  border-radius: 50%;\n}\n\n.templateDefault {\n  position: relative;\n  border-radius: 50%;\n  background-color: #23a094;\n}\n\n.templateDefault p {\n  position: absolute;\n  top: 50%;\n  left: 50%;\n  transform: translate(-50%, -50%);\n  color: #ffffff;\n  margin: 0;\n}\n\n.big {\n  width: 40px;\n  height: 40px;\n}\n\n.medium {\n  width: 30px;\n  height: 32px;\n}\n\n.small {\n  width: 24px;\n  height: 24px;\n}\n',
              ],
              sourceRoot: "",

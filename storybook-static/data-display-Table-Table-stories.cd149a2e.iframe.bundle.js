/*! For license information please see data-display-Table-Table-stories.cd149a2e.iframe.bundle.js.LICENSE.txt */
"use strict";
    ...
    "./src/data-display/Table/Table.stories.tsx": (
      ...
      var jsx_runtime = __webpack_require__(
        ...
        Table = function Table(_ref) {
          ...
          return (0, jsx_runtime.jsx)("table", {
            className: "".concat(Table_Table_module.table),
            children,
          });
        };
      ...
      var TableHead = function TableHead(_ref2) {
        ...
        return (0, jsx_runtime.jsx)("thead", {
          className: "".concat(Table_Table_module.tableHead),
          children,
        });
      };
      ...
      var TableRow = function TableRow(_ref3) {
        ...
        return (0, jsx_runtime.jsx)("tr", {
          className: "".concat(Table_Table_module.tableRow),
          children,
        });
      };
      ...
      var _Template$parameters,
        ...
        TableCell = function TableCell(_ref5) {
          ...
          return (0, jsx_runtime.jsx)("td", {
            className: "".concat(Table_Table_module.tableCell),
      ...
      (module, __webpack_exports__, __webpack_require__) => {
        ...
        ___CSS_LOADER_EXPORT___.push([
          ...
          "",
          {
            ...
            names: [],
            mappings:
              "AAAA;EACE,mBAAmB;EACnB,4BAA4B;AAC9B;;AAEA;EACE,mBAAmB;EACnB,cAAc;EACd,YAAY;EACZ,iBAAiB;AACnB;;AAEA;EACE,4BAA4B;EAC5B,aAAa;AACf;;AAEA;EACE,kBAAkB;EAClB,eAAe;EACf,iBAAiB;EACjB,YAAY;EACZ,aAAa;EACb,uBAAuB;AACzB",
            sourcesContent: [
              ".table {\n  border-spacing: 0px;\n  outline: 1.5px solid #1c1b1f;\n}\n\n.tableHead {\n  background: #1c1b1f;\n  color: #ffffff;\n  height: 56px;\n  border-spacing: 0;\n}\n\n.tableRow {\n  outline: 0.1px solid #1c1b1f;\n  display: flex;\n}\n\n.tableCell {\n  padding: 15px 10px;\n  font-size: 14px;\n  line-height: 20px;\n  width: 150px;\n  display: flex;\n  justify-content: center;\n}\n",
            ],
            sourceRoot: "",
